...
$upload_khs0="namafile";
$upload_kk0="namafile";
$upload_prestasi0="namafile";
?>
...
if($_GET["pro"]=="ubah"){
	...
	$d=getField($conn,$sql);
				...
				$username=$d["username"];
				$password=$d["password"];
				$nama_saudara=$d["nama_saudara"]; //tambahin kolom di db
				$status=$d["status"];
				$tgl1=WKT($d["tgl1"]);
				$tgl2=WKT($d["tgl2"]);
				$tgl3=WKT($d["tgl3"]);
...
<tr>
<td height="41"><label for="id_jabatan">Jabatan Orang Tua</label>
<td>:<td colspan="2"><select name="id_jabatan" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose a State...">
                                <option value="">  </option>
                                <?php
                        
                                $sql=mysqli_query($conn,"select * from tbl_jabatan");
...
<tr>
<td height="50"><label for="nama_saudara">Detail Nama Keluarga</label>
<td>:<td colspan="2"><input class="form-control" name="nama_saudara" type="text" id="nama_saudara" value="<?php echo $nama_saudara;?>" size="25" required/>
</td>
</tr>

<tr>
<td height="50"><label for="status">Detail Status Keluarga</label>
<td>:<td colspan="2"><input class="form-control" name="status" type="text" id="status" value="<?php echo $status;?>" size="25" required/>
</td>
</tr>

<tr>
<td height="50"><label for="tgl1">Detail Tanggal Lahir Keluarga</label>
<td>:<td colspan="2"><input class="form-control" name="tgl1" type="text" id="tgl1" value="<?php echo $tgl1;?>" size="25"><br>
  <input class="form-control" name="tgl2" type="text" id="tgl2" value="<?php echo $tgl2;?>" size="25"><br>
  <input class="form-control" name="tgl3" type="text" id="tgl3" value="<?php echo $tgl3;?>" size="25">
</td>
</tr>
...
<!-- <a href="pendaftar/pdf.php" class="btn btn-primary" style="color:white;">PRINT</a>  -->
<!-- <form action="print.php" method="post" enctype="multipart/form-data" >
<table> 
<tr>
<td><label for="id_periode">Periode</label>
<td>:<td colspan="2"><select name="id_periode" class="chosen-select form-control" id="id_periode" data-placeholder="Choose a State...">
                                <option value="">  </option>
                                <?php
                        
                                $sql=mysqli_query($conn,"select * from tbl_periode");
                                while($data=mysqli_fetch_array($sql))
                                {
...
<td><input type="submit" class="btn btn-info" value="Cetak"></td>
</tr>
...
<form class="form-inline" action="pendaftar/print1.php" method="POST">
...
<table width="1146" class="table table-striped table-bordered table-hover" id="example2">
    ...
    <th width="30%"><center>Data Keluarga</th>
...
<?php  
 ...
 $sql = "SELECT a.*, b.nama_jabatan FROM tbl_pendaftar a
INNER JOIN tbl_jabatan b ON a.id_jabatan = b.id_jabatan order by a.id_pendaftar desc";
  $jum=getJum($conn,$sql);
		if($jum > 0){
	//--------------------------------------------------------------------------------------------
	$batas   = 10;
...
$lahir2 = new DateTime($tgl2);
$hari_ini2 = new DateTime();
$diff2 = $hari_ini2->diff($lahir2);
// Display
$tgl12= date('d M Y', strtotime($tgl2));
$u2= $diff2->y;

$lahir3 = new DateTime($tgl3);
$hari_ini3 = new DateTime();
$diff3 = $hari_ini3->diff($lahir3);
// Display
$tgl13= date('d M Y', strtotime($tgl3));
$u3= $diff3->y;


if ($tgl3 == "0000-00-00" && $u3 =="2019") {$tgl33= ""; $u3="";}
  
  else { $tgl33 = $tgl3; $u3 = $u3; }
...
echo"<tr bgcolor='$color'>
				...
				<br><b>Jabatan Orang Tua</b>: $nama_jabatan
...
if(isset($_POST["Simpan"])){
	...
	$id_jabatan=strip_tags($_POST["id_jabatan"]);
	...
	$nama_saudara=strip_tags($_POST["nama_saudara"]);
	$status=strip_tags($_POST["status"]);
	$tgl1=BAL(strip_tags($_POST["tgl1"]));
	$tgl2=BAL(strip_tags($_POST["tgl2"]));
	$tgl3=BAL(strip_tags($_POST["tgl3"]));
