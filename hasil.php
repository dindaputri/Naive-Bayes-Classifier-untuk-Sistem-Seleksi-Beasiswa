...
echo"<tr bgcolor='$color'>
				<td>$no</td>
				<td><b>$nama ($id_pendaftar)</b> 
				<br><b>Perhitungan: </b><br>$rekapitulasi => <b>$penilaian</b> <br>Status :$status</td>
				<td>
<a href='?mnu=hasil&pro=hapus&kode=$id_hasil'><img src='ypathicon/delete.png' alt='hapus' 
onClick='return confirm(\"Apakah Anda benar-benar akan menghapus $id_hasil pada data tersebut ?..\")'></a></td>
				</tr>";
