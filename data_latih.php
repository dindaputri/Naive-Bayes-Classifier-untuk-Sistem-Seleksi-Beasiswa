...
<div>
<h3>Probabilitas Kelas</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>Kelas<th>Formula<th>Probabilitas</tr>";
...
<h3>Probabilitas IPK</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>IPK<th>Formula Layak<th>Formula Tidak Layak</tr>";
...
<h3>Probabilitas Prestasi</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>Prestasi<th>Formula Layak<th>Formula Tidak Layak</tr>";
...
<h3>Probabilitas Penghasilan</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>Penghasilan<th>Formula Layak<th>Formula Tidak Layak</tr>";
...
<h3>Probabilitas Jumlah Tanggungan</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>Jumlah Tanggungan<th>Formula Layak<th>Formula Tidak Layak</tr>";
...
<h3>Probabilitas Organisasi Yang Diikuti</h3>";
$gab.="<table width='50%' class='table table-striped table-bordered table-hover' border='1'>";
$gab.="<tr><th>Organisasi Yang Diikuti<th>Formula Layak<th>Formula Tidak Layak</tr>";
