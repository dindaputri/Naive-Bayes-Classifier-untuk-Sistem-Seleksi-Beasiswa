...
<html>
  <head>
    ...
    <!-- Ionicons 2.0.0 -->
    <link href="css/ionicons.min.css" rel="stylesheet" type="text/css" />  <!-- <link href="http://code.ionicframework.com/ionicons/2.0.0/css/ionicons.min.css" rel="stylesheet" type="text/css" /> -->   
    <!-- Theme style -->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Grafik Penerimaan Beasiswa',
          is3D: true,
        };
...
<li class="treeview"><a href="index.php?mnu=dashboard"> <i class="fa fa-list"></i> <span>Dashboard</span></a></li>
<li class="treeview"><a href="index.php?mnu=grafik"> <i class="fa fa-pie-chart"></i> <span>Grafik</span></a></li>
...
<li class="treeview"><a href="index.php?mnu=data_testing"> <i class="fa fa-percent"></i> <span>Data Testing</span></a></li>
<li class="treeview"><a href="index.php?mnu=hasil"> <i class="glyphicon glyphicon-refresh"></i> <span>Hasil</span></a></li>
<li class="treeview"><a href="index.php?mnu=monitor"> <i class="fa fa-desktop"></i> <span>Monitor</span></a></li>
...
else if($mnu=="monitor"){require_once"monitoring/monitor.php";}
else if($mnu=="updatemonitor"){require_once"monitoring/updatemonitor.php";}
