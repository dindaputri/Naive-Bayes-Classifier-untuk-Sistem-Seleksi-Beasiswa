...
Nama Mahasiswa: $nama_pendaftar<br> 
<b>IPK:</b> $v1 ($k1)<br>
<b>Prestasi:</b> $v2 ($k2)<br>
<b>Penghasilan:</b> $v3 ($k3)<br>
<b>Jumlah Tanggungan:</b> $v4 ($k4)<br> 
<b>Organisasi:</b> $v5 ($k5)<br>";
...
$_SESSION["gab0"]=$gab0;
$_SESSION["gab"]=$gab;
$_SESSION["gab2"]=$gab22."<hr>Analisa Perhitungan Beasiswa
 $nama_pendaftar Adalah : $nout dengan Nilai Bobot: $max";
